...
import 'package:attendify/app/view_model/user_panel_view_models/user_login_view_model.dart';
...
class _UserLoginScreenState extends State<UserLoginScreen> {
  ...
  UserLoginViewModel userLoginController = Get.put(UserLoginViewModel());
  @override
                ...
                Obx(
                  () {
                    return CustomButtonWidget(
                      text: "Login",
                      isProcessing: userLoginController.isLoading.value,
                      onPressed: () {
                        userLoginController.fieldAuthentication(context);
                      },
                    );
                  },
                )
